...
function selectAnswer(e) {
    ...
    if (correct) {
        checkAnswerEl.innerHTML = "¡Lo hiciste bien!";
    } else {
        checkAnswerEl.innerHTML = "Lo siento, esa no fue la respuesta correcta.";
        if (timeLeft <= 10) {
            timeLeft = 0;
        } else {
...
function saveScore() {
    ...
    setTimeout(function () {
        ...
        document.getElementById("your-score").textContent = "Tu puntaje final es " + timeLeft;
